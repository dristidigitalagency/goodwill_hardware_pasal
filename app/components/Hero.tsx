        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fadeInUp">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white leading-tight mb-6 font-poppins">
              Quality That{" "}
              <span className="text-sky-400">Flows</span>{" "}
              <br className="hidden sm:block" />
              Into Your Home
            </h1>

            <p className="text-slate-300 text-base md:text-lg leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
              Discover our curated collection of premium branded taps, water basins,
              toilet seats, and bathroom fittings. Crafted for elegance, built to last.
            </p>
          ...
          <div className="relative hidden lg:block">
            <div className="grid grid-cols-2 gap-4 animate-float">
              <div className="space-y-4">
                ...
                <div className="relative h-40 rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    src="/images/products/basin1.jpg"
                    alt="Modern water basins"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 50vw"
                  />
              ...
              <div className="space-y-4 mt-8">
                <div className="relative h-40 rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    src="/images/products/seat1.jpg"
                    alt="Toilet seats collection"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 50vw"
                  />
                ...
                <div className="relative h-56 rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    src="/images/products/tap2.jpg"
                    alt="Designer fittings"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 50vw"
                  />
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-4 -left-4 glass rounded-2xl px-5 py-3 shadow-2xl">
              <p className="text-white text-xs font-semibold">✨ Top Brands Available</p>
              <p className="text-sky-300 text-xs">Ask us on WhatsApp</p>
            </div>
          </div>
        </div>
      </div>
